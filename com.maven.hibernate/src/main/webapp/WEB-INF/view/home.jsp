...
<div>
<table border=1>
<tr><td>ID</td><td>First Name</td><td>Last Name</td><td>Email</td><td>Action</td></tr>
...
<a href = ${deleteLink} onclick="if(!(confirm('Are you sure Do you want to delete this customer'))) return false"> Delete </a>
</td>
</tr>
</c:forEach>
</table>
